package OIDC::Lite::Demo::Client::Web::View;
use strict;
use warnings;
use utf8;
use Carp ();
...
use OIDC::Lite::Demo::Client::Web::ViewFunctions;

# setup view class
sub make_instance {
    my ($class, $context) = @_;
    Carp::croak("Usage: OIDC::Lite::Demo::Client::View->make_instance(\$context_class)") if @_!=2;
